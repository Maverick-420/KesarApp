...
const FeatureHighlights = () => {
  return (
    <div className="bg-muted py-12 px-4 sm:px-10 flex flex-wrap justify-center items-center gap-20 text-center text-foreground">
      <div className="w-40 flex flex-col items-center">
        <Sprout size={40} className="text-primary mb-2" />
      ...
      <div className="w-40 flex flex-col items-center">
        <Truck size={40} className="text-primary mb-2" />
        <p className="font-semibold text-sm">
          Domestic
          <br />
          Shipping PAN India
